...
/*  Microwave transmitter configured as a sweep generator
 *
 *  This example configures sinthesyzer MAX2871 to sweep output frequency from a to b.
 *
 *
 *  CLK is pin 13
...
//String2Int function declaration
uint16_t String2Int();
...
void setup() {
  ...
  Serial.println("Sweep configuration example");
  Serial.println("v1.0");
